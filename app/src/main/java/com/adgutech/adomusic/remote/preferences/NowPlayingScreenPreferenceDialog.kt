...
import com.adgutech.adomusic.remote.databinding.PreferenceNowPlayingScreenItemBinding
...
import com.adgutech.adomusic.remote.ui.fragments.NowPlayingScreen.*
import com.adgutech.commons.extensions.*
...
class NowPlayingScreenPreferenceDialog : DialogFragment(), ViewPager.OnPageChangeListener {
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        ...
        viewPager.currentItem = preference.nowPlayingScreen.ordinal

        return materialDialog(R.string.title_preference_playback_theme)
            .setCancelable(false)
            .setPositiveButton(R.string.action_set) { _, _ ->
                ...
                if (isNowPlayingThemes(nowPlayingScreen)) {
                    ...
                    preference.nowPlayingScreen = nowPlayingScreen
                }
            }
            .setView(view)
            .create()
...
private fun isNowPlayingThemes(screen: NowPlayingScreen): Boolean {
    return (screen == Plain || screen == Blur || screen == Color || screen == Simple || screen == Peek) && !App.isProVersion()
}