...
import com.adgutech.adomusic.remote.api.spotify.annotations.DELETEWITHBODY;
import com.adgutech.adomusic.remote.api.spotify.models.Album;
import com.adgutech.adomusic.remote.api.spotify.models.Albums;
import com.adgutech.adomusic.remote.api.spotify.models.AlbumsPager;
import com.adgutech.adomusic.remote.api.spotify.models.Artist;
import com.adgutech.adomusic.remote.api.spotify.models.Artists;
import com.adgutech.adomusic.remote.api.spotify.models.ArtistsCursorPager;
import com.adgutech.adomusic.remote.api.spotify.models.ArtistsPager;
import com.adgutech.adomusic.remote.api.spotify.models.AudioFeaturesTrack;
import com.adgutech.adomusic.remote.api.spotify.models.AudioFeaturesTracks;
import com.adgutech.adomusic.remote.api.spotify.models.CategoriesPager;
import com.adgutech.adomusic.remote.api.spotify.models.Category;
import com.adgutech.adomusic.remote.api.spotify.models.Devices;
import com.adgutech.adomusic.remote.api.spotify.models.FeaturedPlaylists;
import com.adgutech.adomusic.remote.api.spotify.models.NewReleases;
...
import com.adgutech.adomusic.remote.api.spotify.models.PlaylistFollowPrivacy;
...
import com.adgutech.adomusic.remote.api.spotify.models.PlaylistsPager;
import com.adgutech.adomusic.remote.api.spotify.models.QueueTrack;
import com.adgutech.adomusic.remote.api.spotify.models.Recommendations;
...
import com.adgutech.adomusic.remote.api.spotify.models.SeedsGenres;
import com.adgutech.adomusic.remote.api.spotify.models.SnapshotId;
...
import com.adgutech.adomusic.remote.api.spotify.models.Tracks;
import com.adgutech.adomusic.remote.api.spotify.models.TracksPager;
import com.adgutech.adomusic.remote.api.spotify.models.TracksToRemove;
import com.adgutech.adomusic.remote.api.spotify.models.TracksToRemoveWithPosition;
...
public interface SpotifyService {
     ...
     * <p>Valid values are:
     *  <code>long_term</code> calculated from ~1 year of data and including all new data as it becomes available.
     * <code>medium_term</code> approximately last 6 months.
     * <code>short_term</code> approximately last 4 weeks.
     * default: <code>time_range=medium_term</code></p>
     */
     ...
     * <p>Valid values are:
     * <code>album</code>,
     * <code>appears_on</code>,
     * <code>compilation</code>,
     * <code>single</code>
     * example: <code>include_groups=single,appears_on</code></p>
     */
    String INCLUDE_GROUPS = "include_groups";
    ...
    Playlist getPlaylist(@Path("playlist_id") String playlistId);
    ...
    Pager<PlaylistTrack> getPlaylistTracks(@Path("playlist_id") String playlistId);
    ...
    void addTracksToPlaylist(@Path("playlist_id") String playlistId, @QueryMap Map<String, Object> queryParameters, @Body Map<String, Object> body, Callback<Pager<PlaylistTrack>> callback);
     ...
     */
    @DELETEWITHBODY("/playlists/{playlist_id}/tracks")
    void removeTracksFromPlaylist(@Path("playlist_id") String playlistId, @Body TracksToRemove tracksToRemove, Callback<SnapshotId> callback);
     ...
     */
    @DELETEWITHBODY("/playlists/{playlist_id}/tracks")
    SnapshotId removeTracksFromPlaylist(@Path("playlist_id") String playlistId, @Body TracksToRemove tracksToRemove);
     ...
     */
    @DELETEWITHBODY("/playlists/{playlist_id}/tracks")
    void removeTracksFromPlaylist(@Path("playlist_id") String playlistId, @Body TracksToRemoveWithPosition tracksToRemoveWithPosition, Callback<SnapshotId> callback);
     ...
     */
    @DELETEWITHBODY("/playlists/{playlist_id}/tracks")
    SnapshotId removeTracksFromPlaylist(@Path("playlist_id") String playlistId, @Body TracksToRemoveWithPosition tracksToRemoveWithPosition);
    ...
    Result changePlaylistDetails(@Path("playlist_id") String playlistId, @Body Map<String, Object> body);
     ...
     */
    @PUT("/playlists/{playlist_id}")
    void changePlaylistDetails(@Path("playlist_id") String playlistId, @Body Map<String, Object> body, Callback<Result> callback);
    ...
    void followPlaylist(@Path("playlist_id") String playlistId, Callback<Result> callback);
     ...
     */
    @PUT("/playlists/{playlist_id}/followers")
    Result followPlaylist(@Path("playlist_id") String playlistId);
     ...
     */
    @PUT("/playlists/{playlist_id}/followers")
    void followPlaylist(@Path("playlist_id") String playlistId, @Body PlaylistFollowPrivacy playlistFollowPrivacy, Callback<Result> callback);
     ...
     */
    @PUT("/playlists/{playlist_id}/followers")
    Result followPlaylist(@Path("playlist_id") String playlistId, @Body PlaylistFollowPrivacy playlistFollowPrivacy);
    ...
    void unfollowPlaylist(@Path("playlist_id") String playlistId, Callback<Result> callback);
     ...
     */
    @DELETE("/playlists/{playlist_id}/followers")
    Result unfollowPlaylist(@Path("playlist_id") String playlistId);
     ...
     *
     * @param playlistId  The Spotify ID of the playlist.
     * @param contentType The Content Type header. example: <code>"application/json"</code>
     * @param image       Base64 encoded JPEG image data, maximum payload size is 256 KB.
     * @param callback    Callback method.
     * @see <a href="https://developer.spotify.com/documentation/web-api/reference/upload-custom-playlist-cover">Add Custom Playlist Cover Image</a>
     */
    @PUT("/playlists/{playlist_id}/images")
    void uploadImageToPlaylist(
     ...
     * @see <a href="https://developer.spotify.com/documentation/web-api/reference/get-a-users-available-devices">Get available devices</a>
     */
    @GET("/me/player/devices")
    Devices getAvailableDevice();

    @POST("/me/player/play")
    void playUri(@Query("device_id") String deviceId, @Body TrackToPlayPosition body, Callback<Result> callback);

    @POST("/me/player/play")
    void resume(@Query("device_id") String deviceId, Callback<Result> callback);

    @POST("/me/player/pause")
    void pause(@Query("device_id") String deviceId, Callback<Result> callback);

    @POST("/me/player/next")
    void skipNext(@Query("device_id") String deviceId, Callback<Result> callback);

    @POST("/me/player/previous")
    void skipPrevious(@Query("device_id") String deviceId, Callback<Result> callback);

    /**
     * Get the list of objects that make up the user's queue.
     *
     * @return QueueTrack response object
     * @see <a href="https://developer.spotify.com/documentation/web-api/reference/get-queue">Get a Queue’s Tracks</a>
     */
    @GET("/me/player/queue")
    QueueTrack getUserQueue();
     ...
     * @param callback Callback method
     * @see <a href="https://developer.spotify.com/documentation/web-api/reference/add-to-queue">Add Item to Playback Queue</a>
     */
    @POST("/me/player/queue")
    void addToQueue(@Query("uri") String uri, @Query("device_id") String deviceId, Callback<Object> callback);
}
