...
import com.adgutech.adomusic.remote.preferences.NowPlayingScreenPreference
import com.adgutech.adomusic.remote.preferences.NowPlayingScreenPreferenceDialog
...
abstract class AbsSettingsFragment : ATEPreferenceFragmentCompat() {
    ...
    internal fun showProToastAndNavigate(message: String) {
        showToast(getString(R.string.text_pro_feature, message))
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        listView.updatePadding(bottom = dip(com.adgutech.commons.R.dimen.mini_player_height))
