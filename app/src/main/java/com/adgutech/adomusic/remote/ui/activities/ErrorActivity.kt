...
import com.adgutech.commons.utils.Utils.createFile
import com.adgutech.commons.utils.Utils.shareFile
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        moreInfoButton.setOnClickListener { //We retrieve all the error data and show it
            MaterialAlertDialogBuilder(this@ErrorActivity)
                ...
                .setNeutralButton(
                    com.adgutech.commons.R.string.customactivityoncrash_error_activity_error_details_share
                ) { _, _ ->
